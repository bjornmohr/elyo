    ...
    private function seedExercises(): void
    {
        $exercises = [
            [
                ...
                'steps' => [
                    ['text' => 'Aufrecht hinsetzen oder hinstellen, Schultern bewusst senken.', 'pictogram_path' => 'pictograms/nacken-mobilitaet/nacken-dehnung-seitlich/step-1.svg', 'alt' => 'Aufrechte Strichfigur mit bewusst gesenkten Schultern.'],
                    ['text' => 'Kopf langsam zur Seite neigen, bis eine sanfte Dehnung spürbar ist.', 'pictogram_path' => 'pictograms/nacken-mobilitaet/nacken-dehnung-seitlich/step-2.svg', 'alt' => 'Strichfigur neigt den Kopf zur Seite, Pfeil zeigt die Richtung.'],
                    ['text' => '30 Sekunden halten, dann die Seite wechseln.', 'pictogram_path' => 'pictograms/nacken-mobilitaet/nacken-dehnung-seitlich/step-3.svg', 'alt' => 'Geneigter Kopf mit Uhr-Symbol und Seitenwechsel-Pfeil.'],
                ],
            ...
            [
                ...
                'steps' => [
                    ['text' => 'Aufrecht hinsetzen oder hinstellen, Blick geradeaus.', 'pictogram_path' => 'pictograms/nacken-mobilitaet/kinn-retraktion/step-1.svg', 'alt' => 'Aufrechte Strichfigur mit Blickpfeil geradeaus.'],
                    ['text' => 'Kinn gerade nach hinten schieben, ohne den Kopf zu neigen.', 'pictogram_path' => 'pictograms/nacken-mobilitaet/kinn-retraktion/step-2.svg', 'alt' => 'Strichfigur schiebt das Kinn nach hinten, Pfeil zeigt die Richtung.'],
                    ['text' => 'Kurz halten, langsam lösen — 10 Wiederholungen.', 'pictogram_path' => 'pictograms/nacken-mobilitaet/kinn-retraktion/step-3.svg', 'alt' => 'Strichfigur mit Doppelpfeilen für Halten und Lösen.'],
                ],
                'location_tags' => ['office', 'plant', 'home'],
                'posture_tags' => ['sitting', 'standing'],
                'requires_floor' => false,
            ...
            [
                ...
                'steps' => [
                    ['text' => 'Aufrecht hinstellen, eine Hand über den Kopf zur Gegenseite führen.', 'pictogram_path' => 'pictograms/nacken-mobilitaet/oberer-trapez-stretch/step-1.svg', 'alt' => 'Strichfigur führt einen Arm über den Kopf.'],
                    ['text' => 'Kopf sanft Richtung Schulter ziehen, bis es dehnt.', 'pictogram_path' => 'pictograms/nacken-mobilitaet/oberer-trapez-stretch/step-2.svg', 'alt' => 'Geneigter Kopf wird sanft gezogen, Pfeil zeigt die Zugrichtung.'],
                    ['text' => '30 Sekunden halten, dann Seite wechseln.', 'pictogram_path' => 'pictograms/nacken-mobilitaet/oberer-trapez-stretch/step-3.svg', 'alt' => 'Haltende Figur mit Uhr-Symbol und Seitenwechsel-Pfeil.'],
                ],
                'location_tags' => ['office', 'plant', 'home'],
            ...
            [
                ...
                'steps' => [
                    ['text' => 'Erinnerung 30 Minuten vor dem Zubettgehen stellen.', 'pictogram_path' => 'pictograms/abend-routine-schlaf/digital-sunset/step-1.svg', 'alt' => 'Wecker-Symbol als Erinnerung.'],
                    ['text' => 'Alle Bildschirme weglegen oder in den Nicht-stören-Modus schalten.', 'pictogram_path' => 'pictograms/abend-routine-schlaf/digital-sunset/step-2.svg', 'alt' => 'Durchgestrichenes Smartphone.'],
                    ['text' => 'Eine ruhige Alternative wählen: lesen, Musik, Dehnung.', 'pictogram_path' => 'pictograms/abend-routine-schlaf/digital-sunset/step-3.svg', 'alt' => 'Aufgeschlagenes Buch mit Mond-Symbol.'],
                ],
                'location_tags' => ['home'],
                'requires_floor' => false,
                'default_effort' => 1,
            ...
            [
                ...
                'steps' => [
                    ['text' => 'Hüftbreit hinstellen, Knie leicht beugen.', 'pictogram_path' => 'pictograms/abend-routine-schlaf/leichte-abenddehnung/step-1.svg', 'alt' => 'Hüftbreit stehende Strichfigur mit leicht gebeugten Knien.'],
                    ['text' => 'Langsam nach vorne rollen, Arme hängen lassen.', 'pictogram_path' => 'pictograms/abend-routine-schlaf/leichte-abenddehnung/step-2.svg', 'alt' => 'Strichfigur in Vorbeuge mit hängenden Armen und Abwärtspfeil.'],
                    ['text' => 'Drei tiefe Atemzüge, dann Wirbel für Wirbel aufrichten.', 'pictogram_path' => 'pictograms/abend-routine-schlaf/leichte-abenddehnung/step-3.svg', 'alt' => 'Aufgerichtete Figur mit Aufwärtspfeil und Atemwellen.'],
                ],
                'location_tags' => ['home'],
                'posture_tags' => ['standing'],
                'requires_floor' => false,
            ...
            [
                ...
                'steps' => [
                    ['text' => 'Bequem auf den Rücken legen, Augen schließen.', 'pictogram_path' => 'pictograms/abend-routine-schlaf/body-scan-einschlafen/step-1.svg', 'alt' => 'Liegende Strichfigur.'],
                    ['text' => 'Aufmerksamkeit langsam von den Füßen zum Kopf wandern lassen.', 'pictogram_path' => 'pictograms/abend-routine-schlaf/body-scan-einschlafen/step-2.svg', 'alt' => 'Liegende Figur mit Wanderpfeil von den Füßen zum Kopf.'],
                    ['text' => 'Mit jedem Ausatmen bewusst loslassen.', 'pictogram_path' => 'pictograms/abend-routine-schlaf/body-scan-einschlafen/step-3.svg', 'alt' => 'Liegende Figur mit Entspannungswellen und Schlaf-Symbol.'],
                ],
                'location_tags' => ['home'],
                'requires_floor' => false,
                'default_effort' => 1,
            ...
            [
                ...
                'steps' => [
                    ['text' => '4 Sekunden durch die Nase einatmen.', 'pictogram_path' => 'pictograms/atem-balance/box-breathing/step-1.svg', 'alt' => 'Quadrat mit Pfeil entlang der oberen Kante für das Einatmen.'],
                    ['text' => '4 Sekunden den Atem halten, 4 Sekunden ausatmen.', 'pictogram_path' => 'pictograms/atem-balance/box-breathing/step-2.svg', 'alt' => 'Quadrat mit Pfeil entlang der rechten Kante.'],
                    ['text' => '4 Sekunden halten — dann die nächste Runde, insgesamt 4.', 'pictogram_path' => 'pictograms/atem-balance/box-breathing/step-3.svg', 'alt' => 'Quadrat mit umlaufenden Pfeilen für die nächste Runde.'],
                ],
            ...
            [
                ...
                'steps' => [
                    ['text' => 'Aufrecht hinsetzen, Augen schließen.', 'pictogram_path' => 'pictograms/atem-balance/mini-body-scan/step-1.svg', 'alt' => 'Sitzende Strichfigur mit geschlossenen Augen.'],
                    ['text' => 'Schultern, Nacken und Kiefer nacheinander wahrnehmen.', 'pictogram_path' => 'pictograms/atem-balance/mini-body-scan/step-2.svg', 'alt' => 'Sitzende Figur mit markierten Punkten an Schultern und Kiefer.'],
                    ['text' => 'Mit jedem Ausatmen die Region bewusst lockern.', 'pictogram_path' => 'pictograms/atem-balance/mini-body-scan/step-3.svg', 'alt' => 'Sitzende Figur mit Entspannungswellen.'],
                ],
                'location_tags' => ['office', 'home', 'plant', 'onroad'],
            ...
            [
                ...
                'steps' => [
                    ['text' => '4 Sekunden durch die Nase einatmen.', 'pictogram_path' => 'pictograms/atem-balance/4-7-8-atmung/step-1.svg', 'alt' => 'Atemkreis mit Einatem-Pfeil und Zähler.'],
                    ['text' => '7 Sekunden den Atem anhalten.', 'pictogram_path' => 'pictograms/atem-balance/4-7-8-atmung/step-2.svg', 'alt' => 'Uhr-Symbol für das Anhalten des Atems.'],
                    ['text' => '8 Sekunden durch den Mund ausatmen — 4 Zyklen.', 'pictogram_path' => 'pictograms/atem-balance/4-7-8-atmung/step-3.svg', 'alt' => 'Ausatem-Strom mit Wiederholungspfeil.'],
                ],
                'location_tags' => ['office', 'home', 'plant', 'onroad'],
                'posture_tags' => ['sitting', 'standing'],
                'requires_floor' => false,
            ...
            [
                'slug' => 'wandengel',
                'title' => 'Wandengel',
                'short_description' => 'Mobilisiert Schultern und Brustwirbelsäule an der Wand.',
                'description' => 'Der Wandengel öffnet die Brust, mobilisiert die Schulterblätter und wirkt der Rundrückenhaltung entgegen.',
                'exercise_type' => 'MOBILITY',
                'difficulty' => 'BEGINNER',
                'default_duration_minutes' => 3,
                'default_sets' => 2,
                'default_repetitions' => 10,
                'instructions' => 'Mit dem Rücken an die Wand stellen, Arme in W-Position anlegen. Arme langsam an der Wand nach oben und unten gleiten lassen, Kontakt halten.',
                'safety_notes' => 'Unterer Rücken bleibt an der Wand — kein Hohlkreuz.',
                'main_pictogram_path' => 'pictograms/nacken-mobilitaet/wandengel/main.svg',
                'main_pictogram_alt' => 'Strichfigur mit W-Armen an einer Wand, Pfeile zeigen die Gleitbewegung.',
                'steps' => [
                    ['text' => 'Mit Rücken und Hinterkopf an die Wand stellen.', 'pictogram_path' => 'pictograms/nacken-mobilitaet/wandengel/step-1.svg', 'alt' => 'Strichfigur steht mit dem Rücken an der Wand.'],
                    ['text' => 'Arme in W-Position an die Wand legen.', 'pictogram_path' => 'pictograms/nacken-mobilitaet/wandengel/step-2.svg', 'alt' => 'Figur mit angewinkelten Armen in W-Position.'],
                    ['text' => 'Arme langsam nach oben und unten gleiten lassen — 10 Wiederholungen.', 'pictogram_path' => 'pictograms/nacken-mobilitaet/wandengel/step-3.svg', 'alt' => 'Figur streckt die Arme nach oben, Pfeil zeigt auf und ab.'],
                ],
                'location_tags' => ['office', 'plant', 'home'],
                'posture_tags' => ['standing'],
                'requires_floor' => false,
                'default_effort' => 2,
                'tags' => ['BODY_REGION:SHOULDERS', 'BODY_REGION:BACK', 'GOAL:MOBILITY', 'GOAL:POSTURE', 'SETTING:OFFICE', 'EQUIPMENT:NONE'],
            ],
            [
                'slug' => 'progressive-muskelentspannung',
                'title' => 'Progressive Muskelentspannung',
                'short_description' => 'Anspannen und bewusst Loslassen einzelner Muskelgruppen.',
                'description' => 'Kurzform der progressiven Muskelentspannung: Muskelgruppen nacheinander anspannen, halten und bewusst lösen — ideal zum Runterfahren am Abend.',
                'exercise_type' => 'MINDFULNESS',
                'difficulty' => 'BEGINNER',
                'default_duration_minutes' => 5,
                'instructions' => 'Bequem hinlegen oder hinsetzen. Fäuste 5 Sekunden fest ballen, dann lösen und dem Unterschied nachspüren. Mit Armen, Schultern und Beinen wiederholen.',
                'main_pictogram_path' => 'pictograms/abend-routine-schlaf/progressive-muskelentspannung/main.svg',
                'main_pictogram_alt' => 'Liegende Strichfigur mit Anspannungs-Blitz und Entspannungswellen.',
                'steps' => [
                    ['text' => 'Fäuste fest ballen und Anspannung aufbauen.', 'pictogram_path' => 'pictograms/abend-routine-schlaf/progressive-muskelentspannung/step-1.svg', 'alt' => 'Geballte Faust mit Anspannungslinien.'],
                    ['text' => '5 Sekunden halten.', 'pictogram_path' => 'pictograms/abend-routine-schlaf/progressive-muskelentspannung/step-2.svg', 'alt' => 'Uhr-Symbol für fünf Sekunden Halten.'],
                    ['text' => 'Lösen und dem Unterschied nachspüren.', 'pictogram_path' => 'pictograms/abend-routine-schlaf/progressive-muskelentspannung/step-3.svg', 'alt' => 'Entspannungswellen nach dem Loslassen.'],
                ],
                'location_tags' => ['home'],
                'requires_floor' => false,
                'default_effort' => 1,
            ...
            [
                ...
                'short_description' => 'Doppelt so lang aus- wie einatmen — beruhigt sofort.',
                'description' => 'Die Seufzer-Atmung aktiviert den Parasympathikus: normal einatmen, doppelt so lange ausatmen. Funktioniert unauffällig überall.',
                'exercise_type' => 'BREATHING',
                'difficulty' => 'BEGINNER',
                'default_duration_minutes' => 2,
                'default_sets' => 6,
                'instructions' => 'Entspannt durch die Nase einatmen (ca. 3 Sekunden), dann doppelt so lange hörbar ausatmen (ca. 6 Sekunden). 6 ruhige Runden.',
                'default_feedback_prompt' => 'Wie fühlen Sie sich nach der Atemübung?',
                'main_pictogram_path' => 'pictograms/atem-balance/verlaengertes-ausatmen/main.svg',
                'main_pictogram_alt' => 'Strichfigur mit langem, verlängertem Ausatem-Strom.',
                'steps' => [
                    ['text' => 'Normal durch die Nase einatmen (ca. 3 Sekunden).', 'pictogram_path' => 'pictograms/atem-balance/verlaengertes-ausatmen/step-1.svg', 'alt' => 'Kurzer Einatem-Pfeil zum Gesicht.'],
                    ['text' => 'Doppelt so lange ausatmen (ca. 6 Sekunden).', 'pictogram_path' => 'pictograms/atem-balance/verlaengertes-ausatmen/step-2.svg', 'alt' => 'Langer Ausatem-Strom mit Pfeil.'],
                    ['text' => '6 ruhige Runden wiederholen.', 'pictogram_path' => 'pictograms/atem-balance/verlaengertes-ausatmen/step-3.svg', 'alt' => 'Wiederholungspfeil für sechs Runden.'],
                ],
                'location_tags' => ['office', 'home', 'plant', 'onroad'],
                'posture_tags' => ['sitting', 'standing'],
                'requires_floor' => false,
            ...
            [
                'slug' => 'beckenkippen-sitzend',
                'title' => 'Beckenkippen im Sitzen',
                'short_description' => 'Mobilisiert die Lendenwirbelsäule direkt am Schreibtisch.',
                'description' => 'Sanftes Vor- und Zurückkippen des Beckens lockert den unteren Rücken nach langem Sitzen — unauffällig auf jedem Stuhl machbar.',
                'exercise_type' => 'MOBILITY',
                'difficulty' => 'BEGINNER',
                'default_duration_minutes' => 2,
                'default_sets' => 2,
                'default_repetitions' => 10,
                'instructions' => 'Aufrecht an die Stuhlvorderkante setzen. Becken langsam nach vorne kippen (leichtes Hohlkreuz), dann nach hinten rollen (Rücken rund). 10 langsame Wiederholungen.',
                'safety_notes' => 'Bewegung klein und schmerzfrei halten.',
                'main_pictogram_path' => 'pictograms/ruecken-fit-alltag/beckenkippen-sitzend/main.svg',
                'main_pictogram_alt' => 'Auf einem Stuhl sitzende Strichfigur mit Kipp-Pfeilen am Becken.',
                'steps' => [
                    ['text' => 'Aufrecht an die Stuhlvorderkante setzen.', 'pictogram_path' => 'pictograms/ruecken-fit-alltag/beckenkippen-sitzend/step-1.svg', 'alt' => 'Aufrecht auf der Stuhlvorderkante sitzende Figur.'],
                    ['text' => 'Becken langsam vor- und zurückkippen.', 'pictogram_path' => 'pictograms/ruecken-fit-alltag/beckenkippen-sitzend/step-2.svg', 'alt' => 'Sitzende Figur mit Kipp-Pfeilen am Becken.'],
                    ['text' => '10 langsame Wiederholungen.', 'pictogram_path' => 'pictograms/ruecken-fit-alltag/beckenkippen-sitzend/step-3.svg', 'alt' => 'Sitzende Figur mit Wiederholungspfeil.'],
                ],
                'location_tags' => ['office', 'home'],
                'posture_tags' => ['sitting'],
                'requires_floor' => false,
                'default_effort' => 1,
                'tags' => ['BODY_REGION:BACK', 'BODY_REGION:HIPS', 'GOAL:MOBILITY', 'SETTING:DESK', 'SETTING:OFFICE', 'EQUIPMENT:CHAIR'],
            ],
            [
                'slug' => 'katze-kuh-stehend',
                'title' => 'Katze-Kuh im Stehen',
                'short_description' => 'Mobilisiert die gesamte Wirbelsäule ohne Matte.',
                'description' => 'Die stehende Variante von Katze-Kuh: mit den Händen auf den Oberschenkeln abwechselnd den Rücken runden und ins Hohlkreuz strecken.',
                'exercise_type' => 'MOBILITY',
                'difficulty' => 'BEGINNER',
                'default_duration_minutes' => 3,
                'default_sets' => 2,
                'default_repetitions' => 8,
                'instructions' => 'Leicht in die Knie gehen, Hände auf die Oberschenkel stützen. Ausatmen und den Rücken rund machen, einatmen und sanft ins Hohlkreuz strecken. 8 Wiederholungen.',
                'safety_notes' => 'Bewegung fließend, kein Schwung.',
                'main_pictogram_path' => 'pictograms/ruecken-fit-alltag/katze-kuh-stehend/main.svg',
                'main_pictogram_alt' => 'Vorgebeugte Strichfigur mit Händen auf den Oberschenkeln und Rundungs-Pfeilen.',
                'steps' => [
                    ['text' => 'Leicht in die Knie, Hände auf die Oberschenkel.', 'pictogram_path' => 'pictograms/ruecken-fit-alltag/katze-kuh-stehend/step-1.svg', 'alt' => 'Figur stützt die Hände auf die Oberschenkel.'],
                    ['text' => 'Ausatmen — Rücken rund machen (Katze).', 'pictogram_path' => 'pictograms/ruecken-fit-alltag/katze-kuh-stehend/step-2.svg', 'alt' => 'Figur mit rundem Rücken und Aufwärtspfeil.'],
                    ['text' => 'Einatmen — sanft ins Hohlkreuz strecken (Kuh).', 'pictogram_path' => 'pictograms/ruecken-fit-alltag/katze-kuh-stehend/step-3.svg', 'alt' => 'Figur mit gestrecktem Rücken und Abwärtspfeil.'],
                ],
                'location_tags' => ['office', 'home', 'plant'],
                'posture_tags' => ['standing'],
                'requires_floor' => false,
                'default_effort' => 2,
                'tags' => ['BODY_REGION:BACK', 'GOAL:MOBILITY', 'SETTING:OFFICE', 'SETTING:HOME', 'EQUIPMENT:NONE'],
            ],
            [
                'slug' => 'wand-brustdehnung',
                'title' => 'Brustdehnung an der Wand',
                'short_description' => 'Öffnet die Brust und entlastet den oberen Rücken.',
                'description' => 'Dehnung der Brustmuskulatur am Türrahmen oder an der Wand — gleicht die typische nach vorn gezogene Sitzhaltung aus.',
                'exercise_type' => 'MOBILITY',
                'difficulty' => 'BEGINNER',
                'default_duration_minutes' => 2,
                'default_sets' => 2,
                'default_hold_seconds' => 30,
                'instructions' => 'Unterarm auf Schulterhöhe an Wand oder Türrahmen legen. Körper langsam von der Wand wegdrehen, bis die Dehnung in der Brust spürbar ist. 30 Sekunden halten, Seite wechseln.',
                'safety_notes' => 'Nur bis zur angenehmen Dehnung drehen.',
                'main_pictogram_path' => 'pictograms/ruecken-fit-alltag/wand-brustdehnung/main.svg',
                'main_pictogram_alt' => 'Strichfigur mit Unterarm an der Wand, Pfeil zeigt die Drehrichtung des Körpers.',
                'steps' => [
                    ['text' => 'Unterarm auf Schulterhöhe an die Wand legen.', 'pictogram_path' => 'pictograms/ruecken-fit-alltag/wand-brustdehnung/step-1.svg', 'alt' => 'Figur legt den Unterarm an die Wand.'],
                    ['text' => 'Körper langsam von der Wand wegdrehen.', 'pictogram_path' => 'pictograms/ruecken-fit-alltag/wand-brustdehnung/step-2.svg', 'alt' => 'Figur dreht den Körper weg, Pfeil zeigt die Richtung.'],
                    ['text' => '30 Sekunden halten, dann Seite wechseln.', 'pictogram_path' => 'pictograms/ruecken-fit-alltag/wand-brustdehnung/step-3.svg', 'alt' => 'Haltende Figur mit Uhr-Symbol und Seitenwechsel-Pfeil.'],
                ],
                'location_tags' => ['office', 'home', 'plant'],
                'posture_tags' => ['standing'],
                'requires_floor' => false,
        ...
        $templates = [
            ...
            [
                ...
                'exercises' => [
                    ...
                    ['slug' => 'wandengel', 'position' => 5, 'is_required' => false],
                ],
            ],
            [
                ...
                'exercises' => [
                    ...
                    ['slug' => 'progressive-muskelentspannung', 'position' => 3, 'is_required' => false],
                    ['slug' => 'body-scan-einschlafen', 'position' => 4, 'is_required' => true],
                ],
            ],
            [
                'slug' => 'atem-balance',
                ...
                'exercises' => [
                    ...
                    ['slug' => 'verlaengertes-ausatmen', 'position' => 3, 'is_required' => false],
                    ['slug' => 'mini-body-scan', 'position' => 4, 'is_required' => true],
                ],
            ],
            [
                'slug' => 'ruecken-fit-alltag',
                'title' => 'Rücken-Fit im Alltag',
                'short_description' => 'Drei kurze Mobilisationen gegen Rückenbeschwerden vom Sitzen.',
                'description' => 'Beckenkippen, Katze-Kuh im Stehen und Brustdehnung an der Wand — drei Übungen, die den Rücken zwischendurch mobilisieren, ganz ohne Matte.',
                'goal_summary' => 'Rückenschmerzen vom Sitzen reduzieren',
                'category' => 'MOBILITY',
                'difficulty' => 'BEGINNER',
                'estimated_duration_minutes' => 8,
                'recommended_frequency' => 'DAILY',
                'default_points' => 5,
                'target_signal' => 'back_pain',
                'assignment_reason_template' => 'aus Check-in „Rückenschmerzen“',
                'effect_metric' => 'pain',
                'effect_metric_unit' => 'nrs_0_10',
                'location_tags' => ['office', 'home', 'plant'],
                'posture_tags' => ['sitting', 'standing'],
                'requires_floor' => false,
                'exercises' => [
                    ['slug' => 'beckenkippen-sitzend', 'position' => 1, 'is_required' => true],
                    ['slug' => 'katze-kuh-stehend', 'position' => 2, 'is_required' => true],
                    ['slug' => 'wand-brustdehnung', 'position' => 3, 'is_required' => true],
                ],
            ],
        ];
